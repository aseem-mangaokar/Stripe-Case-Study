...
Ingrained in its single platform for payments are optimized checkout flows, machine learning fraud prevention, modern billing and payments, multi-party payments and custom pricing models to suit a wide variety of customers. Thousands of platforms, including Shopify, DocuSign, Squarespace, and Wix partner with Stripe in order to facilitate an easy, user-friendly experience for their customers to make payments.The rise in popularity of rideshare services (Lyft, Uber) and delivery apps (Doordash, Instacart) resulted in a need for the support of multi-party payment, which Stripe supports. Of particular significance is its support for recurring subscriptions. Subscription-based software services such as Zoom, Expensify, TaxJar, Asana, Notion and Tableau Software all partner with Stripe to manage their billing. 
...
Stripe is markedly effective in fulfilling its mission of "increasing the GDP of the Internet." Where the common approach to payments processing was targeting just the end-use consumers (buyers and sellers), Stripe positioned itself in order to shake the space in a different manner. It removed many of the barriers to entry that exist in the online business space, concurrently appealing to developers by making its API and documentation fast and easy to implement and providing a deep set of developer-focused features. Targeting developers first was key to Stripe's eventual success - they first provided an easy solution to the main group of people involved in integrating payments, and were able to develop their product to the point that they could market it to significantly broader customer base. Proceeding to focus obsessively on customer experience, the company is able to engage with its community of users and improve their product where possible. Nowadays, Stripe is potently advertised as the payment solution of choice for entrepreneurs, small businesses and startups alike - the company's marketing suggests its simultaneous appeal to both the tech-savvy and the technologically challenged; their user-friendly customer interfaces bear the same enticing sheen as Apple products. An apt metaphor describes Stripe as a "toll booth on the highway of the internet economy...with traffic growing all the time, they are in a great place to profit from it."
...
- [https://stripe.com/about] (Stripe mission statement)
...
- [https://blog.chartmogul.com/why-is-stripe-so-popular/] (why stripe is popular)